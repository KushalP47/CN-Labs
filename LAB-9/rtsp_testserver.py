...
def main():
    ...
    server.set_address("127.0.0.47")  # server address
    server.set_service("5000")  # server port
    print("Server address: rtsp://localhost:5000/test")
    ...
    pipeline_string = (
    "filesrc location=/Users/kushalpatel/Desktop/College Stuff/CN/LAB/LAB-9/chrome.mp4 ! "
    "decodebin ! videoconvert ! x264enc ! rtph264pay name=pay0 pt=96"
)
    ...
    print("Stream: rtsp://localhost:5000/test")
